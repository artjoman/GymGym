...
object Reminders {
    ...
    fun schedule(context: Context, settings: ReminderSettings, nextMissionAt: Long?, now: Long) {
        ...
        if (settings.bodyReminderEnabled) {
            val data = notifData(context, NOTIF_BODY, R.string.reminder_body_title, R.string.reminder_body_text)
    ...
    private fun notifData(context: Context, id: Int, titleRes: Int, textRes: Int): Data =
        Data.Builder()
            .putInt("id", id)
...
class ReminderWorker(
    ...
    override fun doWork(): Result {
        ...
        Reminders.post(context, id, title, text)
